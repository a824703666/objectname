(function($) {
    $.ajax({
      ...
      $(".shopcard-box1").html(strhtml);
      $(".shopcard-box2").html(strhtml);
      $(".shopcard-box3").html(strhtml);
      $(".shopcard-box4").html(strhtml);
      $(".shopcard-box5").html(strhtml);
      $(".shopcard-box6").html(strhtml);
    });
  })(jQuery);
  //1.获取楼梯，给楼梯添加点击事件。
